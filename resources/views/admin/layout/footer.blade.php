...
<footer
  ...
  <div class="container border-top pt-5">
    <!-- Section: Links -->
      <div class="row justify-content-center text-center border-bottom mt-3 pb-3">
        ...
        <div class="col-lg-4 col-md-6 col-sm-6 col-4 mb-4 mb-md-0">
          <a href="tel:+556136429450">
            ...
            <div class="d-none d-sm-block">
              <p class="fs-5 pt-3">contato</p>
            </div>
          </a>
        </div>
        <!--column endereço-->
        <div class="col-lg-4 col-md-6 col-sm-6 col-4 mb-4 mb-md-0">
          <a href="https://www.google.com/maps/place/IFG+-+C%C3%A2mpus+Formosa/@-15.562847,-47.327808,10z/data=!4m6!3m5!1s0x9350a2f73fd3c36f:0xb8ffbb72c45a6bd6!8m2!3d-15.5628475!4d-47.3278082!16s%2Fg%2F11bbrlt0dm?hl=pt-BR&entry=ttu">
        ...
        <!--column e-mail-->
        <div class="col-lg-4 col-md-6 col-sm-6 col-4 mb-4 mb-md-0">
            <a href="mailto:secitec2023@gmail.com">
  ...
  <div class="text-center p-4" >
    <p class="fs-6">
      © 2023 Copyright:
      <a class="text-dark link-underline-success link-tutorial" href="{{ url('/creditos') }}" target="_blank">Nome Birreria</a>
    </p>
  </div>
