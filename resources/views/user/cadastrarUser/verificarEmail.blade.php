            ...
            <div class="card border-0 shadow rounded-3 my-5">
                <div class="card-body p-4 p-sm-5">
                    ...
                    <form action="{{url('/user/verificar-email')}}" method="post">
                        ...
                        <div class="container">
                            <small class="opacity-50">Informe o seu email. Será enviado um email com link para você. <br> <strong>Cheque o a caixa de entrada e sua caixa de spam</strong>.</small>
                        </div>
